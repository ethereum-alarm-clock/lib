...
async function getWeb3() {
    const WEB3_PROVIDER = 'https://rarely-suitable-shark.quiknode.io/87817da9-942d-4275-98c0-4176eee51e1a/aB5gwSfQdN4jmkS65F1HyA==/';
    let web3;
...
(async () => {
    ...
    eac.schedule({
        ...
        windowStart: new BigNumber(moment().add('1', 'days').unix()), // required
        // -- optional --
